...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		List<Integer> toto = new ArrayList<Integer>();

		for (int i = 0; i < numVertices; i++) {
			toto.add(getInNeighbors(i).size() + getNeighbors(i).size());
		}
		Collections.sort(toto, new Comparator<Integer>() {
			@Override
	...
	public String toString() {
		String s = "\nGraph with " + numVertices + " vertices and " + numEdges
				+ " edges.\n";
